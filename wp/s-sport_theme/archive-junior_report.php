<?php
/**
 * Template Name: アーカイブページ - スポーツ少年団/年間行事予定 - 過去のレポート
 * Template Post Type: post, page

 */
get_header();
$project_year=$_GET["junior_project_year"];
?>
      <main class="l-main">
...
<?php endif;?>
                    ...
                    <?php the_field("junior_project_report")?>
                  </div>
                  <?php
$images = get_field('junior_project_gallery'); 
if( $images ): 
?>
